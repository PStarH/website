                ...
                <div>
                    ...
                    <n-flex vertical :size="48">
                        ...
                        <div>
                            ...
                            <div style="text-align: center"><n-image width="100%" src="/website/images/BFSexplain.png"></n-image>
                            </div>
                            <div style="text-align: center;"><n-image width="100%" lazy src="/website/images/bfs_demo.gif"></n-image>
                            </div>
                            ...
                            (Vertices+Edges)
                            <div style="text-align: center; align-content: center;"><n-image width="70%" src="/website/images/graph.png"></n-image></div>
                        </div>
                        <div>
                            ...
                            <div style="text-align: center;"><n-image width="100%" lazy
                                    src="/website/images/binarysearch.gif"></n-image>
                            </div>
                        ...
                        <div>
                            ...
                            <div style="display: flex; align-items: center;">
                                <n-statistic style="font-weight: bold; padding-right: 1.75rem;"
                                    label="Time Complexity"><img style="width: 100%" src="/website/images/time_complexity.png"
                                        alt=""></n-statistic>
                            </div>
